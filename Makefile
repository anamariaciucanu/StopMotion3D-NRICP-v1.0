...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) obj/QtCamera1.0.0/ && $(COPY_FILE) --parents headers/matrix.h headers/logger.h headers/glfwcontainer.h headers/load_functions.h headers/camera.h headers/shader.h headers/mesh.h headers/NRICP.h headers/segmentation.h headers/linker.h obj/QtCamera1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/matrix.cpp src/logger.cpp src/glfwcontainer.cpp src/shader.cpp src/mesh.cpp src/NRICP.cpp src/segmentation.cpp src/linker.cpp obj/QtCamera1.0.0/ && (cd `dirname obj/QtCamera1.0.0` && $(TAR) QtCamera1.0.0.tar QtCamera1.0.0 && $(COMPRESS) QtCamera1.0.0.tar) && $(MOVE) `dirname obj/QtCamera1.0.0`/QtCamera1.0.0.tar.gz . && $(DEL_FILE) -r obj/QtCamera1.0.0
...
obj/segmentation.o: src/segmentation.cpp headers/segmentation.h \
		headers/mesh.h \
		../../../Libs/eigen_1/Eigen/Eigen \
		../../../Libs/eigen_1/Eigen/Dense \
		../../../Libs/eigen_1/Eigen/Core \
		...
		headers/logger.h \
		headers/matrix.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/segmentation.o src/segmentation.cpp

obj/linker.o: src/linker.cpp headers/linker.h \
		headers/segmentation.h \
		headers/mesh.h \
		../../../Libs/eigen_1/Eigen/Eigen \
		../../../Libs/eigen_1/Eigen/Dense \
		...
		headers/logger.h \
		headers/matrix.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/linker.o src/linker.cpp
